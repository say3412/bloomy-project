...
// const addLineCount = 5 - contents.length;
// const addlines = contents.length < 5;
...
//             borderBottomColor: '#e3d6e5',
//           },

//           '& .MuiInput-underline:hover:before': {
//             borderBottomColor: 'var(--mui-palette-primary-light)',
//           },

//           '& .MuiInput-underline:after': {
//             borderBottomColor: '#d488c7',
//           },
//         }}
//       />
//     </Stack>
//   ))}
//   {addlines && Array.from({ length: addLineCount }).map((_, index) => (
